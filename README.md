...
## Changelog
### 2026-09-24
I implemented texture batching and bindless textures. Textures are now uploaded with a single staging buffer, and textures are referenced via an index into a single descriptor array. This was the first addition I made to the renderer without the help of tutorials. Since learning to write high quality code is still a priority of mine, I didn't use AI to write the code, but I did use it somewhat to understand Vulkan concepts better.
